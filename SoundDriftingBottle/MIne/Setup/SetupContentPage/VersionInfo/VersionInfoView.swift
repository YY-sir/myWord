...
class VersionInfoView: UIView {
    ...
    fileprivate func setupView(){
        contentTableView = UITableView(frame: CGRect(x: 0, y: CommonOne().topPadding + 44, width: self.frame.width, height: self.frame.height - CommonOne().topPadding - 44), style: .grouped)
