...
//}
//- (void)configAudio;
//- (void)didClickStartOrStop:(UIButton *)sender;
//@end
...
{
    AudioUnitRecord *vc = (__bridge AudioUnitRecord *)(inRefCon);
...
- (void)earReturnStop{
    AudioOutputUnitStop(_audioUint);
//    AudioQueuePause(_audioQueue);
    AudioQueueStop(_audioQueue, NULL);
}
