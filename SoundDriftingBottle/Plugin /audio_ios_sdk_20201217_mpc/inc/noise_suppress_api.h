...
//*****************************************************************************
// Function: Do noise suppression for input speech frame by frame.
//
// ATTENTION: the length of one frame should be 10ms, that is 160 points for 16kHz.
//
// Input
...
//      - PCMOut: PCM samples after NS.
//
// Return value:  0 - OK
//                others - Error
//*****************************************************************************
extern INT32 TT_NS_Process_Frame(VOID *NS_inst, INT16 *PCMIn, INT16 *PCMOut);
...
//*****************************************************************************
//  Function: Set NS params when user tuning.
//
// Input:
//      -  NS_inst: Pointer to an NS instance that was initialized ALREADY.
//
// Output:
//      -  NS_inst: updated NS instance.
...
//                others - Error
//*****************************************************************************
extern INT32 TT_NS_SetParams(VOID *NS_inst, stNSConfig *pstConfig);
